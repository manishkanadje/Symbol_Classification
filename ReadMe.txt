To test the 1-Nearest Neighbor classifier (trained on all of the dataset) against a folder containing inkml files:
    ...
    Step 2: execute: python executeNNClassifier.py ./trainingFeaturesJoblib/all_features.joblib ./trainingFeaturesJoblib/all_labels.joblib <inkml_folder> <lg_output_folder>
...
To train the classifier and test it (using 2/3 - 1/3 split) for 1-Nearest Neighbor: 
    Step 1: execute: python oneNN.py

To train the classifier and test it (using 2/3 - 1/3 split) for Random Forest: 
